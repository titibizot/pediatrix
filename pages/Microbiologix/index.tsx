  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative flex justify-center mt-8">
        {/* Logo en arrière-plan du conteneur central */}
		...
		{/* Footer pour Pédiatrix */}
      <footer className="bg-white py-8">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <Link href="/" legacyBehavior>
            <a className="text-sm font-medium text-gray-500 hover:text-blue-700 underline">
              Retour à l'accueil global
            </a>
          </Link>
          <p className="mt-4 text-gray-400 text-xs">
            © {new Date().getFullYear()} Medixgame - Pédiatrix. Tous droits réservés.
          </p>
        </div>
      </footer>
    </div>
